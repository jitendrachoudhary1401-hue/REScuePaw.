...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
  ...
  return (
    <div className="flex flex-col h-full animate-in fade-in duration-500 overflow-y-auto pr-1">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <button 
          ...
          className="flex items-center justify-center gap-2 py-3 bg-white border border-gray-200 rounded-2xl hover:bg-gray-50 hover:border-gray-300 transition-all active:scale-95 shadow-sm"
        >
        ...
        <button 
          ...
          className="flex items-center justify-center gap-2 py-3 bg-gray-900 text-white rounded-2xl hover:bg-black transition-all active:scale-95 shadow-lg shadow-gray-200"
        >
      ...
      <div className="mt-8 pb-4">
        <div className="p-4 bg-gray-50 rounded-[1.5rem] border border-gray-100">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-[10px] font-bold text-gray-600 uppercase tracking-widest">Quick Demo Access (Offline)</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            {demoAccounts.map((acc) => (
              <button
                ...
                className="bg-white border border-gray-100 p-2 rounded-xl text-left hover:border-emerald-200 transition-all active:scale-95 group shadow-sm hover:shadow-md"
              >
                <div className="text-[9px] font-bold text-emerald-600 uppercase tracking-tighter">{acc.role}</div>
                <div className="text-[10px] text-gray-400 font-medium truncate group-hover:text-gray-900">{acc.email}</div>
              </button>
            ))}
          </div>
        </div>
